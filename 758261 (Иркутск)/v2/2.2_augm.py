...
"""
REAL_DIR = pathlib.Path(TRAIN_DIR, "v2s6_action")
OUT_DIR = pathlib.Path(TRAIN_DIR, "v2s6_action_aug")
...
def get_random_attributes(img):
    font_size = random.randint(8, 100) 
...
for label in tqdm(os.listdir(REAL_DIR)):
