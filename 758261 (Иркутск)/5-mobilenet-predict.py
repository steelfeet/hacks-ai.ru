...
TEST_DIR = pathlib.Path(TRAIN_DIR, "imgs_real")

MODEL_FILENAME_ACTION = "mobilenet-action.pth"
MODEL_FILENAME_EMPLOYEE = "mobilenet-employee.pth"
SUBMISSION_FILENAME = "submission-1.csv"
...
model_action.load_state_dict(torch.load(str(pathlib.Path(BASE_DIR, "models", MODEL_FILENAME_ACTION))))
model_action.eval()
...
print()
print("Load state dict:")
model_employee.load_state_dict(torch.load(str(pathlib.Path(BASE_DIR, "models", MODEL_FILENAME_EMPLOYEE))))
model_employee.eval()
